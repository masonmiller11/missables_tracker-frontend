...
import { Button, Card, Divider, Classes, ButtonGroup, Icon, Intent, Elevation, H5 } from '@blueprintjs/core';
      ...
      <Card className={classes.templateCard}>
          <div className={classes.templateTileCardContainer}>
            ...
            <div className={classes.templateCardTitleAndAuthorContainer}>
              <h2 className={classes.templateCardTitle}><a href="#">{template.title}</a></h2>
